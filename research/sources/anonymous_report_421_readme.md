...
Evaluation code and a bilingual technical report by [Yu-Mool Shu](mailto:244679245@qq.com) and [Lipxin Zheng](mailto:572554250@qq.com).
...
This is a history-free source release. It contains no credentials, private annotations, raw model sessions, original operations logs, simulator assets or model checkpoints. The website repository additionally hosts all 100 evaluation videos and 43 gallery clips. The report contains one extra historical demonstration clip used only for qualitative analysis.
...
@misc{shu2026astra,
  ...
  author       = {Shu, Yu-Mool and Zheng, Lipxin},
  year         = {2026},
