...
Version 0.14 (2026-09-15): Control 4–16, Data 17–24, Improvement 25–33, closing 34–35.
35 slides, 19 clips, 55-minute suggested timing. HTML SHA-256 `dca813ac76e82ccf8e504fefe007df3c970afdbc2795e151a3a4f8f640dabe90`.

Current scope: `research/revision_0_14_spec.md`. Fixed comparison is `.build/revision_0_14_baseline/`,
...
Code replay authority: `research/code_video_v0_14_sources.json`, checked by `.build/code_video_v014.py`. All18 previous clips remain unchanged; code replay makes19.
...
`.build/v0_14_extended_audit.json` for actual hash-bound status. Final v0.14 QA/review passed; Standards0 / Spec0, no unresolved findings; see `research/revision_0_14_review.md`. Prior v0.9 source-freeze P2 remains resolved.
...
Data now includes Real-to-sim Replay / Data Rollout and the hand CAD case (23). DexGPT original comparison (24) is a failed physical-acceptance example, not a new detailed study. Control timing (15) separates Asim published query seconds from controller Hz and Go1 simulation-time feedback.

P15 is now latency-only (ASIM); P16 has four authored inline SVG icons and two open problems. Page-number typos in user edits are resolved by the exact quoted text. P10 Waypoint proprio is a highlighted column, not a universal winner; Can delta18/20 exceeds waypoint17/20. Current polish/build scope is v0.14.
