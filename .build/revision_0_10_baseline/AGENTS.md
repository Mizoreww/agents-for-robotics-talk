...
One self-contained HTML technical talk — 36 English slides, Chinese speaker script, 18 embedded clips,
...
Version 0.9 (2026-09-14): Control 4–18, Simulation 19–25, Improvement 26–34, closing 35–36.
36 slides, 18 clips, 60-minute suggested timing. HTML SHA-256 `eb25dad97e0adc4947b19d76b165dfb7ecb27a1276702c3068ee344cfc8e14f7`.

Current scope: `research/revision_0_9_spec.md`. Fixed comparison is `.build/revision_0_9_baseline/`,
...
`.build/v0_9_extended_audit.json` for actual hash-bound status. Final v0.9 QA/review passed; source-freeze P2 resolved (see `research/revision_0_9_review.md`).
...
Pending user reference: WeChat taxonomy article is safety-blocked; do not bypass it or attribute an unverified taxonomy to it. Await supplied article text/figures.
