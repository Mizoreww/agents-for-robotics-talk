...
assert [r['group'] for r in deck['slides']]==['Introduction']*3+['1 · Agent Controls Robot']*15+['2 · Agent Builds Simulation']*7+['3 · Agent Improves Policy']*9+['Other Applications / Closing']*2
expected_titles=['Agents for Robotics', 'Demo: Painting with Feedback', 'Three Roles for Robotics Agents', 'Agent Controls Robot', 'Hierarchical Robot Control', 'Hi Robot: Instruction and Progress', 'Claude Plays Robotics: Interfaces', 'Claude: The Value of a Motor Prior', 'RPent: Organizing Robot Tools', 'RPent: Harness VLA Results', 'Astra: Direct Actions in Practice', 'Astra: Visual Feedback in Action', 'Same Astra, Different Action Outputs', 'Astra Interfaces: Three Tasks', 'Astra: Direct or Hybrid?', 'RoboDojo: Per-Task Results', 'RoboLab: Selected Final Slots', 'Where Should the Boundary Sit?', 'Agent Builds Simulation', 'Real Episode and Its Twin', 'Agentic Real2Sim: Method', 'DROID-100: Protocol and Results', 'Real2Sim: All Backend Results', 'Astra Builds Simulation Workflows', 'From Replay to Prediction', 'Agent Improves Policy', 'ENPIRE: Environment and Improvement', 'ENPIRE: Reset and Verification', 'ENPIRE: What Did the Agent Change?', 'ENPIRE: Pin Insertion Curve', 'ENPIRE: Two Physical Tasks', 'ENPIRE: Autoresearch in RoboCasa', 'Astra: Training and Context', 'ENPIRE: Cost and Chapter Summary', 'Beyond: Structural Design', 'Changing the Division of Work']
