...
expected_order=[1,2,3,4,None,None,5,6,7,8,9,None,10,11,12,13,None,14,15,16,17,18,None,19,20,22]
...
for label in ['Agent Tools','IK / motion planner','Controller code','VLA / learned policy','WAM','Perception / state tools']:
 assert label in deck['slides'][4]['html'],label
assert 'extend the report' in deck['slides'][4]['html']
assert deck['slides'][5]['new_slide_key']=='toolkits' and not deck['slides'][5]['chapter_opening']
assert 'Official RPent service-oriented framework' in deck['slides'][5]['html']
assert 'DreamZero is not marked supported' in deck['slides'][5]['html']
