...
## Current revision: tool ecosystem and broader applications — completed
...
- Browser file:// navigation is blocked by app policy. The delivery was tested on loopback from a folder containing only the HTML; CSP prohibits external runtime requests.
